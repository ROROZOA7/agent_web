...
- `templates/`: optional decision, plan, runbook, and Harness-improvement structures.

## Agent Workflow

- `.pi/settings.json`: project-local Pi package declarations.
- `.pi/better-harness/`: generated Better Harness reports; ignored local output.
- `AGENTS.md` and `WORKFLOW.md`: entrypoint and operating route for Pi/OMP.
